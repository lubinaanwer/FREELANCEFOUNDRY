...
<html lang="en">
  <head>
    <title>Worker &mdash;Update</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="http://localhost:8085/FREELANCE_FOUNDRY_MAIN_PROJECT/http://localhost:8085/FREELANCE_FOUNDRY_MAIN_PROJECT/template/css/magnific-popup.css">
          ...
          <div class="col-12" data-aos="fade">
			...
			<div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="WorkerName" class="form-control" name="WorkerName" value='<%=worker.getWorkerName()%>' pattern="[A-Z a-z]{3,15}" title="enter a valid name" required placeholder="Full Name">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6">
                  <label class="font-weight-bold" for="address">Address</label>
                  <textarea class="form-control" rows="5" id="WorkerAddress" name="WorkerAddress" required>
              ...
              <div class="form-group row">
                <div class="col-md-4">
                  ...
                  <input type="text" id="Age" class="form-control" name="Age" value='<%=worker.getAge()%>' pattern="[0-9]{1,3}" title="enter a valid age" required>
                </div>
              ...
              <div class="form-group row">
                <div class="col-md-4">
                  ...
                  <input type="text" id="Experience" class="form-control"  name="Experience" value='<%=worker.getExperience()%>' pattern="[0-9]{1,2}" title="enter a valid experience" required placeholder="Experience">
                </div>
              
              
                <div class="col-md-4">
                  <label class="font-weight-bold" for="email">Phone</label>
                  <input type="text" id="WorkerPhone" class="form-control" name="WorkerPhone" value='<%=worker.getWorkerPhone()%>' required pattern="[7-9]{1}[0-9]{9}" title="enter a valid mobile number" placeholder="Phone Number">
                </div>
              
                <div class="col-md-4">
                  <label class="font-weight-bold" for="email">Wages</label>
                  <input type="text" id="Wages" class="form-control" name="Wages" value='<%=worker.getWages()%>' pattern="[0-9]{1,4}" title="enter a valid wage" placeholder="Wages(Per Hour)">
                </div>
              </div>
              <div class="form-group row">
               <div class="col-md-12">
