...
<html lang="en">
  <head>
    <title>Seeker &mdash;Update</title>
    <meta charset="utf-8">
          ...
          <div class="col-12" data-aos="fade">
			...
			<div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="SeekerName" class="form-control" name="SeekerName" value='<%=seeker.getSeekerName()%>' pattern="[A-Z a-z]{3,15}" title="enter a valid name" required placeholder="Full Name">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6">
                  <label class="font-weight-bold" for="address">Address</label>
                  <textarea class="form-control" rows="5" id="SeekerAddress" name="SeekerAddress" required>
                  <%=seeker.getSeekerAddress()%></textarea>
                 </div>
                
                <div class="col-md-6">
                  <label class="font-weight-bold" for="email">Phone</label>
                  <input type="text" id="SeekerPhone" class="form-control" name="SeekerPhone" value='<%=seeker.getSeekerPhone()%>' required pattern="[7-9]{1}[0-9]{9}" title="enter a valid mobile number" placeholder="Phone Number">
                </div>
