...
<html lang="en">
  <head>
    <title>Worker &mdash;Delete</title>
    <meta charset="utf-8">
		...
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-150"><br><br><br><br>
					<% 
					  ArrayList<WorkerDTO> workers=WorkerBL.getPendingWorkers();
							...
							<tr class="row100">
								...
								<td><%=worker.getAdminApproval()%></td>
									<td><a href="worker_approval_process.jsp?worker_id=<%=worker.getWorkerId() %>">Approve<br>/</a>
					      			<a href="delete_process_workers.jsp?WorkerId=<%=worker.getWorkerId()%>" onclick="return confirm('Are you sure?')">Delete</a>
								</td>	
