      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-6" data-aos="fade">
           ...
           <form action="login_process.jsp" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" id="submit" value="Login" class="btn btn-primary pill px-4 py-2">
                </div>
              </div>
            </form>
