					...
					<table data-vertable="ver1">
						<thead>
							<tr class="row100 head">
								...
								<th class="column100 column11" data-column="column11">BOOK HERE</th>
								<th class="column100 column12" data-column="column12">PROFILE</th>
							</tr>
						</thead>
						<tbody>
						<%for(WorkerDTO worker:workers)
							...
							<tr class="row100">
								...
								<td><a href="workers_booking.jsp?WorkerId=<%=worker.getWorkerId()%>&SeekerId=<%=id%>">Book</a></td>
							    <td><a href="worker_page.jsp?WorkerId=<%=worker.getWorkerId()%>">View Profile</a></td>
