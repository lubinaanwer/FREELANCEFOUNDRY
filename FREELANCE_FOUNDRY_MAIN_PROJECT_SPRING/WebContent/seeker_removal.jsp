...
<html lang="en">
  <head>
    <title>Seeker &mdash;Removal</title>
    <meta charset="utf-8">
		...
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-150"><br><br><br><br>
					<% 
					  ArrayList<SeekerDTO> seekers=SeekerBL.getDeletionRequests();
					...
					<table data-vertable="ver1">
						<thead>
							<tr class="row100 head">
								...
								<th class="column100 column6" data-column="column6">APPROVAL STATUS</th>
						...
						<%for(SeekerDTO seeker:seekers)
							...
							<tr class="row100">
								...
								<td class="column100 column8" data-column="column8"><%=seeker.getSeekerPhone()%></td>
								<td><%=seeker.getAdminApproval()%></td>
									<td><a href="seeker_approval_process.jsp?Seeker_id=<%=seeker.getSeekerId() %>">Approve<br>/</a>
					      			<a href="delete_process_seeker_admin.jsp?SeekerId=<%=seeker.getSeekerId()%>" onclick="return confirm('Are you sure?')">Delete</a>
								</td>	
