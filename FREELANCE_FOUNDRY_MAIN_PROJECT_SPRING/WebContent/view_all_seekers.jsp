...
<html lang="en">
<head>
	<title>view &mdash;all&mdash; seekers</title>
	<meta charset="UTF-8">
					...
					<table data-vertable="ver1">
						<thead>
							<tr class="row100 head">
								...
								<th class="column100 column5" data-column="column5">EDIT</th>
						...
						<%for(SeekerDTO seeker:seekers)
							...
							<tr class="row100">
								...
								<a href="seekers_update.jsp?SeekerId=<%=seeker.getSeekerId()%>">Edit</a></td>
								<td class="column100 column6" data-column="column6">
								<a href="seekers_delete.jsp?SeekerId=<%=seeker.getSeekerId()%>" onclick="return confirm('Are you sure?')">Delete</a></td>
							</tr>
