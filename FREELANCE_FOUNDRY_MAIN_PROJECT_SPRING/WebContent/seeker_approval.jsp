...
<html lang="en">
  <head>
    <title>Seeker &mdash;Approval</title>
    <meta charset="utf-8">
		...
		<div class="container-table100">
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-150">
					<% ArrayList<SeekerDTO> seekers=SeekerBL.getPendingSeekers();
					...
					<table data-vertable="ver1">
						<thead>
							<tr class="row100 head">
								...
								<th class="column100 column5" data-column="column5">APPROVAL STATUS</th>
						...
						<%for(SeekerDTO seeker:seekers)
								...
								<tr>
									...
									<td><a href="seeker_approval_process.jsp?seeker_id=<%= seeker.getSeekerId() %>">Approve</a>/<br>
								    <a href="seeker_delete.jsp?seeker_id=<%= seeker.getSeekerId() %>">Delete</a></td>
								</tr>
								<%}
